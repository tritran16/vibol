...
@endif
{{ Form::open(array('action' => ['Admin\BannersController@store'], 'method' => 'POST', 'enctype' => 'multipart/form-data')) }}
    ...
    <a class="btn btn-default" href="{{route('banners.index')}}"> {{__('common.button.cancel')}}</a>
{{ Form::close() }}
