...
@endif
{{ Form::open(array('action' => ['Admin\PoetryController@store'], 'method' => 'POST', 'enctype' => 'multipart/form-data')) }}
    ...
    <div class="form-group">
        {{ Form::label('description', __('poetry.content')) }}
        {{ Form::textarea('description', request('content', null), array('class' => 'form-control', 'id' => 'content')) }}
    </div>
    <div class="form-group">
    ...
    <a class="btn btn-default" href="{{route('poetrys.index')}}"> {{__('common.button.cancel')}}</a>
{{ Form::close() }}
