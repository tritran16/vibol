                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach ($news as $item)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td><a href="{{route('news.show', $item->id)}}"><img src="/images/thumb/{{$item->thumbnail}}" width="100px"/> {{ $item->title }}</a></td>
                                ...
                                <td>
                                    @if ($item->status != 1)
                                        <a type="button" class="btn btn-success" href="{{route('admin.news.active', $item->id)}}" onclick="confirm('Do you want active this News?')">
